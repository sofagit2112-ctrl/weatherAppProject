...
class MainInfo(QFrame):
    def __init__(self, city_name = "Dnipro"):
        ...
        self.weather_info = WeatherInfo(city_name=self.city_name)
        self.horizontal_layout.addWidget(self.weather_info)

        self.time_info = TimeInfo(city_name=self.city_name)
        self.horizontal_layout.addWidget(self.time_info)

        self.main_layout.addWidget(self.main_container)

        self.forecast_info = ForecastInfo(city_name=self.city_name)
        self.main_layout.addWidget(self.forecast_info)

        self.graphics_info = GraphicsInfo(city_name=self.city_name)
